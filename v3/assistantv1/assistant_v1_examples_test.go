	...
	Describe(`AssistantV1 request examples`, func() {
		...
		It(`DeleteWorkspace request example`, func() {
			...
			if response.StatusCode != 200 {
				fmt.Printf("\nUnexpected response status code received from DeleteWorkspace(): %d\n", response.StatusCode)
			}
		...
		It(`DeleteValue request example`, func() {
			...
			if response.StatusCode != 200 {
				fmt.Printf("\nUnexpected response status code received from DeleteValue(): %d\n", response.StatusCode)
			}
		...
		It(`DeleteSynonym request example`, func() {
			...
			if response.StatusCode != 200 {
				fmt.Printf("\nUnexpected response status code received from DeleteSynonym(): %d\n", response.StatusCode)
			}
		...
		It(`DeleteIntent request example`, func() {
			...
			if response.StatusCode != 200 {
				fmt.Printf("\nUnexpected response status code received from DeleteIntent(): %d\n", response.StatusCode)
			}
		...
		It(`DeleteExample request example`, func() {
			...
			if response.StatusCode != 200 {
				fmt.Printf("\nUnexpected response status code received from DeleteExample(): %d\n", response.StatusCode)
			}
		...
		It(`DeleteEntity request example`, func() {
			...
			if response.StatusCode != 200 {
				fmt.Printf("\nUnexpected response status code received from DeleteEntity(): %d\n", response.StatusCode)
			}
		...
		It(`DeleteDialogNode request example`, func() {
			...
			if response.StatusCode != 200 {
				fmt.Printf("\nUnexpected response status code received from DeleteDialogNode(): %d\n", response.StatusCode)
			}
		...
		It(`DeleteCounterexample request example`, func() {
			...
			if response.StatusCode != 200 {
				fmt.Printf("\nUnexpected response status code received from DeleteCounterexample(): %d\n", response.StatusCode)
			}
