...
func UnmarshalDialogNodeOutputGeneric(m map[string]json.RawMessage, result interface{}) (err error) {
	...
	if discValue == "audio" {
		err = core.UnmarshalModel(m, "", result, UnmarshalDialogNodeOutputGenericDialogNodeOutputResponseTypeAudio)
	} else if discValue == "channel_transfer" {
	...
	} else if discValue == "iframe" {
		err = core.UnmarshalModel(m, "", result, UnmarshalDialogNodeOutputGenericDialogNodeOutputResponseTypeIframe)
	...
	} else if discValue == "video" {
		err = core.UnmarshalModel(m, "", result, UnmarshalDialogNodeOutputGenericDialogNodeOutputResponseTypeVideo)
	} else {
...
func (*AssistantV1) NewOutputData(logMessages []LogMessage) (_model *OutputData, err error) {
	_model = &OutputData{
...
func UnmarshalRuntimeResponseGeneric(m map[string]json.RawMessage, result interface{}) (err error) {
	...
	if discValue == "audio" {
		err = core.UnmarshalModel(m, "", result, UnmarshalRuntimeResponseGenericRuntimeResponseTypeAudio)
	} else if discValue == "channel_transfer" {
		...
		err = core.UnmarshalModel(m, "", result, UnmarshalRuntimeResponseGenericRuntimeResponseTypeIframe)
	} else if discValue == "image" {
		...
		err = core.UnmarshalModel(m, "", result, UnmarshalRuntimeResponseGenericRuntimeResponseTypeVideo)
	} else {
		err = fmt.Errorf("unrecognized value for discriminator property 'response_type': %s", discValue)
	}
	return
...
// SetProperty allows the user to set an arbitrary property on an instance of WorkspaceSystemSettings
func (o *WorkspaceSystemSettings) SetProperty(key string, value interface{}) {
	if o.additionalProperties == nil {
		o.additionalProperties = make(map[string]interface{})
	}
	o.additionalProperties[key] = value
...
// SetProperties allows the user to set a map of arbitrary properties on an instance of WorkspaceSystemSettings
func (o *WorkspaceSystemSettings) SetProperties(m map[string]interface{}) {
	o.additionalProperties = make(map[string]interface{})
	for k, v := range m {
		o.additionalProperties[k] = v
	}
...
// GetProperty allows the user to retrieve an arbitrary property from an instance of WorkspaceSystemSettings
func (o *WorkspaceSystemSettings) GetProperty(key string) interface{} {
	return o.additionalProperties[key]
}

// GetProperties allows the user to retrieve the map of arbitrary properties from an instance of WorkspaceSystemSettings
func (o *WorkspaceSystemSettings) GetProperties() map[string]interface{} {
	return o.additionalProperties
}

// MarshalJSON performs custom serialization for instances of WorkspaceSystemSettings
func (o *WorkspaceSystemSettings) MarshalJSON() (buffer []byte, err error) {
	m := make(map[string]interface{})
	if len(o.additionalProperties) > 0 {
		for k, v := range o.additionalProperties {
			m[k] = v
	...
	if o.Disambiguation != nil {
		m["disambiguation"] = o.Disambiguation
	}
	if o.HumanAgentAssist != nil {
		m["human_agent_assist"] = o.HumanAgentAssist
	}
	if o.SpellingSuggestions != nil {
		m["spelling_suggestions"] = o.SpellingSuggestions
	}
	...
	if o.SystemEntities != nil {
		m["system_entities"] = o.SystemEntities
	}
	if o.OffTopic != nil {
		m["off_topic"] = o.OffTopic
	}
	buffer, err = json.Marshal(m)
	return
}
...
// DialogNodeOutputGenericDialogNodeOutputResponseTypeAudio : DialogNodeOutputGenericDialogNodeOutputResponseTypeAudio struct
// This model "extends" DialogNodeOutputGeneric
type DialogNodeOutputGenericDialogNodeOutputResponseTypeAudio struct {
	// The type of response returned by the dialog node. The specified response type must be supported by the client
	// application or channel.
...
// NewDialogNodeOutputGenericDialogNodeOutputResponseTypeAudio : Instantiate DialogNodeOutputGenericDialogNodeOutputResponseTypeAudio (Generic Model Constructor)
func (*AssistantV1) NewDialogNodeOutputGenericDialogNodeOutputResponseTypeAudio(responseType string, source string) (_model *DialogNodeOutputGenericDialogNodeOutputResponseTypeAudio, err error) {
	_model = &DialogNodeOutputGenericDialogNodeOutputResponseTypeAudio{
...
func (*DialogNodeOutputGenericDialogNodeOutputResponseTypeAudio) isaDialogNodeOutputGeneric() bool {
	return true
}

// UnmarshalDialogNodeOutputGenericDialogNodeOutputResponseTypeAudio unmarshals an instance of DialogNodeOutputGenericDialogNodeOutputResponseTypeAudio from the specified map of raw messages.
func UnmarshalDialogNodeOutputGenericDialogNodeOutputResponseTypeAudio(m map[string]json.RawMessage, result interface{}) (err error) {
	obj := new(DialogNodeOutputGenericDialogNodeOutputResponseTypeAudio)
	...
	err = core.UnmarshalPrimitive(m, "channel_options", &obj.ChannelOptions)
	if err != nil {
		return
	}
...
// DialogNodeOutputGenericDialogNodeOutputResponseTypeIframe : DialogNodeOutputGenericDialogNodeOutputResponseTypeIframe struct
// This model "extends" DialogNodeOutputGeneric
type DialogNodeOutputGenericDialogNodeOutputResponseTypeIframe struct {
	// The type of response returned by the dialog node. The specified response type must be supported by the client
	// application or channel.
	ResponseType *string `json:"response_type" validate:"required"`
...
// NewDialogNodeOutputGenericDialogNodeOutputResponseTypeIframe : Instantiate DialogNodeOutputGenericDialogNodeOutputResponseTypeIframe (Generic Model Constructor)
func (*AssistantV1) NewDialogNodeOutputGenericDialogNodeOutputResponseTypeIframe(responseType string, source string) (_model *DialogNodeOutputGenericDialogNodeOutputResponseTypeIframe, err error) {
	_model = &DialogNodeOutputGenericDialogNodeOutputResponseTypeIframe{
		ResponseType: core.StringPtr(responseType),
		Source:       core.StringPtr(source),
	}
	err = core.ValidateStruct(_model, "required parameters")
...
func (*DialogNodeOutputGenericDialogNodeOutputResponseTypeIframe) isaDialogNodeOutputGeneric() bool {
	return true
}

// UnmarshalDialogNodeOutputGenericDialogNodeOutputResponseTypeIframe unmarshals an instance of DialogNodeOutputGenericDialogNodeOutputResponseTypeIframe from the specified map of raw messages.
func UnmarshalDialogNodeOutputGenericDialogNodeOutputResponseTypeIframe(m map[string]json.RawMessage, result interface{}) (err error) {
	obj := new(DialogNodeOutputGenericDialogNodeOutputResponseTypeIframe)
	err = core.UnmarshalPrimitive(m, "response_type", &obj.ResponseType)
	if err != nil {
		return
	}
...
// DialogNodeOutputGenericDialogNodeOutputResponseTypeVideo : DialogNodeOutputGenericDialogNodeOutputResponseTypeVideo struct
// This model "extends" DialogNodeOutputGeneric
type DialogNodeOutputGenericDialogNodeOutputResponseTypeVideo struct {
	// The type of response returned by the dialog node. The specified response type must be supported by the client
	// application or channel.
	ResponseType *string `json:"response_type" validate:"required"`
...
// NewDialogNodeOutputGenericDialogNodeOutputResponseTypeVideo : Instantiate DialogNodeOutputGenericDialogNodeOutputResponseTypeVideo (Generic Model Constructor)
func (*AssistantV1) NewDialogNodeOutputGenericDialogNodeOutputResponseTypeVideo(responseType string, source string) (_model *DialogNodeOutputGenericDialogNodeOutputResponseTypeVideo, err error) {
	_model = &DialogNodeOutputGenericDialogNodeOutputResponseTypeVideo{
		ResponseType: core.StringPtr(responseType),
		Source:       core.StringPtr(source),
	}
	err = core.ValidateStruct(_model, "required parameters")
...
func (*DialogNodeOutputGenericDialogNodeOutputResponseTypeVideo) isaDialogNodeOutputGeneric() bool {
	return true
}

// UnmarshalDialogNodeOutputGenericDialogNodeOutputResponseTypeVideo unmarshals an instance of DialogNodeOutputGenericDialogNodeOutputResponseTypeVideo from the specified map of raw messages.
func UnmarshalDialogNodeOutputGenericDialogNodeOutputResponseTypeVideo(m map[string]json.RawMessage, result interface{}) (err error) {
	obj := new(DialogNodeOutputGenericDialogNodeOutputResponseTypeVideo)
	err = core.UnmarshalPrimitive(m, "response_type", &obj.ResponseType)
	if err != nil {
		return
	}
...
// RuntimeResponseGenericRuntimeResponseTypeAudio : RuntimeResponseGenericRuntimeResponseTypeAudio struct
...
// NewRuntimeResponseGenericRuntimeResponseTypeAudio : Instantiate RuntimeResponseGenericRuntimeResponseTypeAudio (Generic Model Constructor)
func (*AssistantV1) NewRuntimeResponseGenericRuntimeResponseTypeAudio(responseType string, source string) (_model *RuntimeResponseGenericRuntimeResponseTypeAudio, err error) {
	_model = &RuntimeResponseGenericRuntimeResponseTypeAudio{
		ResponseType: core.StringPtr(responseType),
		Source:       core.StringPtr(source),
	}
	err = core.ValidateStruct(_model, "required parameters")
...
func (*RuntimeResponseGenericRuntimeResponseTypeAudio) isaRuntimeResponseGeneric() bool {
	return true
}
...
func UnmarshalRuntimeResponseGenericRuntimeResponseTypeAudio(m map[string]json.RawMessage, result interface{}) (err error) {
	obj := new(RuntimeResponseGenericRuntimeResponseTypeAudio)
	err = core.UnmarshalPrimitive(m, "response_type", &obj.ResponseType)
	if err != nil {
		return
	}
...
// RuntimeResponseGenericRuntimeResponseTypeIframe : RuntimeResponseGenericRuntimeResponseTypeIframe struct
// This model "extends" RuntimeResponseGeneric
...
// NewRuntimeResponseGenericRuntimeResponseTypeIframe : Instantiate RuntimeResponseGenericRuntimeResponseTypeIframe (Generic Model Constructor)
func (*AssistantV1) NewRuntimeResponseGenericRuntimeResponseTypeIframe(responseType string, source string) (_model *RuntimeResponseGenericRuntimeResponseTypeIframe, err error) {
	_model = &RuntimeResponseGenericRuntimeResponseTypeIframe{
		ResponseType: core.StringPtr(responseType),
		Source:       core.StringPtr(source),
	}
	err = core.ValidateStruct(_model, "required parameters")
...
func (*RuntimeResponseGenericRuntimeResponseTypeIframe) isaRuntimeResponseGeneric() bool {
	return true
}
...
func UnmarshalRuntimeResponseGenericRuntimeResponseTypeIframe(m map[string]json.RawMessage, result interface{}) (err error) {
	obj := new(RuntimeResponseGenericRuntimeResponseTypeIframe)
	err = core.UnmarshalPrimitive(m, "response_type", &obj.ResponseType)
	if err != nil {
		return
	}
...
// RuntimeResponseGenericRuntimeResponseTypeVideo : RuntimeResponseGenericRuntimeResponseTypeVideo struct
// This model "extends" RuntimeResponseGeneric
...
// NewRuntimeResponseGenericRuntimeResponseTypeVideo : Instantiate RuntimeResponseGenericRuntimeResponseTypeVideo (Generic Model Constructor)
func (*AssistantV1) NewRuntimeResponseGenericRuntimeResponseTypeVideo(responseType string, source string) (_model *RuntimeResponseGenericRuntimeResponseTypeVideo, err error) {
	_model = &RuntimeResponseGenericRuntimeResponseTypeVideo{
		ResponseType: core.StringPtr(responseType),
		Source:       core.StringPtr(source),
	}
	err = core.ValidateStruct(_model, "required parameters")
...
func (*RuntimeResponseGenericRuntimeResponseTypeVideo) isaRuntimeResponseGeneric() bool {
	return true
}
...
func UnmarshalRuntimeResponseGenericRuntimeResponseTypeVideo(m map[string]json.RawMessage, result interface{}) (err error) {
	obj := new(RuntimeResponseGenericRuntimeResponseTypeVideo)
	err = core.UnmarshalPrimitive(m, "response_type", &obj.ResponseType)
	if err != nil {
		return
	}
