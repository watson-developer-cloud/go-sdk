...
// DialogNodeVisited : An objects containing detailed diagnostic information about a dialog node that was triggered during processing of the
// input message.
...
func UnmarshalMessageContextGlobalSystem(m map[string]json.RawMessage, result interface{}) (err error) {
	...
	err = core.UnmarshalPrimitive(m, "skip_user_input", &obj.SkipUserInput)
	if err != nil {
		return
	}
	reflect.ValueOf(result).Elem().Set(reflect.ValueOf(obj))
...
func UnmarshalMessageInput(m map[string]json.RawMessage, result interface{}) (err error) {
	...
	err = core.UnmarshalModel(m, "attachments", &obj.Attachments, UnmarshalMessageInputAttachment)
	if err != nil {
		return
	}
...
func UnmarshalMessageInputAttachment(m map[string]json.RawMessage, result interface{}) (err error) {
	obj := new(MessageInputAttachment)
	err = core.UnmarshalPrimitive(m, "url", &obj.URL)
	if err != nil {
		return
	}
	err = core.UnmarshalPrimitive(m, "media_type", &obj.MediaType)
	if err != nil {
		return
	}
	reflect.ValueOf(result).Elem().Set(reflect.ValueOf(obj))
...
func UnmarshalMessageOutputDebug(m map[string]json.RawMessage, result interface{}) (err error) {
	...
	err = core.UnmarshalModel(m, "nodes_visited", &obj.NodesVisited, UnmarshalDialogNodeVisited)
	if err != nil {
		return
	}
