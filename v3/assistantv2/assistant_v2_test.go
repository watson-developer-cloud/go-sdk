...
var _ = Describe(`AssistantV2`, func() {
	...
	Describe(`Message(messageOptions *MessageOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke Message with error: Operation response processing error`, func() {
				...
				messageInputAttachmentModel := new(assistantv2.MessageInputAttachment)
				messageInputAttachmentModel.URL = core.StringPtr("testString")
				messageInputAttachmentModel.MediaType = core.StringPtr("testString")
				...
				messageInputModel.Attachments = []assistantv2.MessageInputAttachment{*messageInputAttachmentModel}
				...
				messageContextGlobalSystemModel.SkipUserInput = core.BoolPtr(true)
				...
				messageContextModel.Integrations = map[string]interface{}{"anyKey": "anyValue"}
	...
	Describe(`MessageStateless(messageStatelessOptions *MessageStatelessOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke MessageStateless with error: Operation response processing error`, func() {
				...
				messageInputStatelessModel.Attachments = []assistantv2.MessageInputAttachment{*messageInputAttachmentModel}
				...
				messageContextStatelessModel.Integrations = map[string]interface{}{"anyKey": "anyValue"}
	...
	Describe(`Model constructor tests`, func() {
		Context(`Using a service client instance`, func() {
			...
			It(`Invoke NewMessageInputAttachment successfully`, func() {
				url := "testString"
				_model, err := assistantService.NewMessageInputAttachment(url)
				Expect(_model).ToNot(BeNil())
				Expect(err).To(BeNil())
			})
			It(`Invoke NewMessageOptions successfully`, func() {
				...
				// Construct an instance of the MessageInputAttachment model
				messageInputAttachmentModel := new(assistantv2.MessageInputAttachment)
				Expect(messageInputAttachmentModel).ToNot(BeNil())
				messageInputAttachmentModel.URL = core.StringPtr("testString")
				messageInputAttachmentModel.MediaType = core.StringPtr("testString")
				Expect(messageInputAttachmentModel.URL).To(Equal(core.StringPtr("testString")))
				Expect(messageInputAttachmentModel.MediaType).To(Equal(core.StringPtr("testString")))
				...
				Expect(messageInputModel.Attachments).To(Equal([]assistantv2.MessageInputAttachment{*messageInputAttachmentModel}))
				...
				Expect(messageContextGlobalSystemModel.SkipUserInput).To(Equal(core.BoolPtr(true)))
				...
				Expect(messageContextModel.Integrations).To(Equal(map[string]interface{}{"anyKey": "anyValue"}))
			...
			It(`Invoke NewMessageStatelessOptions successfully`, func() {
				...
				Expect(messageInputStatelessModel.Attachments).To(Equal([]assistantv2.MessageInputAttachment{*messageInputAttachmentModel}))
				...
				Expect(messageContextStatelessModel.Integrations).To(Equal(map[string]interface{}{"anyKey": "anyValue"}))
