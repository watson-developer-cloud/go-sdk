...
// QueryCollectionNotices : Query collection notices
...
func (discovery *DiscoveryV2) QueryCollectionNotices(queryCollectionNoticesOptions *QueryCollectionNoticesOptions) (result *QueryNoticesResponse, response *core.DetailedResponse, err error) {
	return discovery.QueryCollectionNoticesWithContext(context.Background(), queryCollectionNoticesOptions)
}
...
func (discovery *DiscoveryV2) QueryCollectionNoticesWithContext(ctx context.Context, queryCollectionNoticesOptions *QueryCollectionNoticesOptions) (result *QueryNoticesResponse, response *core.DetailedResponse, err error) {
	err = core.ValidateNotNil(queryCollectionNoticesOptions, "queryCollectionNoticesOptions cannot be nil")
	if err != nil {
		return
	}
	err = core.ValidateStruct(queryCollectionNoticesOptions, "queryCollectionNoticesOptions")
	if err != nil {
		return
	}

	pathParamsMap := map[string]string{
		"project_id":    *queryCollectionNoticesOptions.ProjectID,
		"collection_id": *queryCollectionNoticesOptions.CollectionID,
	}

	builder := core.NewRequestBuilder(core.GET)
	builder = builder.WithContext(ctx)
	builder.EnableGzipCompression = discovery.GetEnableGzipCompression()
	_, err = builder.ResolveRequestURL(discovery.Service.Options.URL, `/v2/projects/{project_id}/collections/{collection_id}/notices`, pathParamsMap)
	if err != nil {
		return
	}

	for headerName, headerValue := range queryCollectionNoticesOptions.Headers {
		builder.AddHeader(headerName, headerValue)
	}

	sdkHeaders := common.GetSdkHeaders("discovery", "V2", "QueryCollectionNotices")
	for headerName, headerValue := range sdkHeaders {
		builder.AddHeader(headerName, headerValue)
	}
	builder.AddHeader("Accept", "application/json")
	...
	builder.AddQuery("version", fmt.Sprint(*discovery.Version))
	if queryCollectionNoticesOptions.Filter != nil {
		builder.AddQuery("filter", fmt.Sprint(*queryCollectionNoticesOptions.Filter))
	}
	if queryCollectionNoticesOptions.Query != nil {
		builder.AddQuery("query", fmt.Sprint(*queryCollectionNoticesOptions.Query))
	}
	if queryCollectionNoticesOptions.NaturalLanguageQuery != nil {
		builder.AddQuery("natural_language_query", fmt.Sprint(*queryCollectionNoticesOptions.NaturalLanguageQuery))
	}
	if queryCollectionNoticesOptions.Count != nil {
		builder.AddQuery("count", fmt.Sprint(*queryCollectionNoticesOptions.Count))
	}
	if queryCollectionNoticesOptions.Offset != nil {
		builder.AddQuery("offset", fmt.Sprint(*queryCollectionNoticesOptions.Offset))
	}
...
// QueryNotices : Query project notices
...
// DeleteTrainingQuery : Delete a training data query
...
func (discovery *DiscoveryV2) DeleteTrainingQuery(deleteTrainingQueryOptions *DeleteTrainingQueryOptions) (response *core.DetailedResponse, err error) {
	return discovery.DeleteTrainingQueryWithContext(context.Background(), deleteTrainingQueryOptions)
}
...
func (discovery *DiscoveryV2) DeleteTrainingQueryWithContext(ctx context.Context, deleteTrainingQueryOptions *DeleteTrainingQueryOptions) (response *core.DetailedResponse, err error) {
	err = core.ValidateNotNil(deleteTrainingQueryOptions, "deleteTrainingQueryOptions cannot be nil")
	if err != nil {
		return
	}
	err = core.ValidateStruct(deleteTrainingQueryOptions, "deleteTrainingQueryOptions")
	if err != nil {
		return
	}

	pathParamsMap := map[string]string{
		"project_id": *deleteTrainingQueryOptions.ProjectID,
		"query_id":   *deleteTrainingQueryOptions.QueryID,
	}
	...
	for headerName, headerValue := range deleteTrainingQueryOptions.Headers {
		builder.AddHeader(headerName, headerValue)
	}

	sdkHeaders := common.GetSdkHeaders("discovery", "V2", "DeleteTrainingQuery")
	for headerName, headerValue := range sdkHeaders {
		builder.AddHeader(headerName, headerValue)
	}
...
func (*DiscoveryV2) NewDeleteTrainingQueryOptions(projectID string, queryID string) *DeleteTrainingQueryOptions {
	return &DeleteTrainingQueryOptions{
		ProjectID: core.StringPtr(projectID),
...
func (*DiscoveryV2) NewQueryCollectionNoticesOptions(projectID string, collectionID string) *QueryCollectionNoticesOptions {
	return &QueryCollectionNoticesOptions{
		ProjectID:    core.StringPtr(projectID),
		CollectionID: core.StringPtr(collectionID),
	}
}
...
// SetHeaders : Allow user to set Headers
func (options *QueryCollectionNoticesOptions) SetHeaders(param map[string]string) *QueryCollectionNoticesOptions {
	options.Headers = param
	return options
}
...
func UnmarshalQueryLargePassages(m map[string]json.RawMessage, result interface{}) (err error) {
	...
	err = core.UnmarshalPrimitive(m, "find_answers", &obj.FindAnswers)
	if err != nil {
		return
	}
	err = core.UnmarshalPrimitive(m, "max_answers_per_passage", &obj.MaxAnswersPerPassage)
	if err != nil {
		return
	}
	reflect.ValueOf(result).Elem().Set(reflect.ValueOf(obj))
...
func UnmarshalQueryResponsePassage(m map[string]json.RawMessage, result interface{}) (err error) {
	...
	err = core.UnmarshalModel(m, "answers", &obj.Answers, UnmarshalResultPassageAnswer)
	if err != nil {
		return
	}
	reflect.ValueOf(result).Elem().Set(reflect.ValueOf(obj))
...
func UnmarshalResultPassageAnswer(m map[string]json.RawMessage, result interface{}) (err error) {
	obj := new(ResultPassageAnswer)
	err = core.UnmarshalPrimitive(m, "answer_text", &obj.AnswerText)
	if err != nil {
		return
	}
	err = core.UnmarshalPrimitive(m, "start_offset", &obj.StartOffset)
