...
var _ = Describe(`SpeechToTextV1`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprintf(res, "%s", `{"models": [{"name": "Name", "language": "Language", "rate": 4, "url": "URL", "supported_features": {"custom_language_model": false, "custom_acoustic_model": false, "speaker_labels": false, "low_latency": true}, "description": "Description"}]}`)
				}))
			})
		...
		Context(`Using mock server endpoint with timeout`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					res.Header().Set("Content-type", "application/json")
					res.WriteHeader(200)
					fmt.Fprintf(res, "%s", `{"name": "Name", "language": "Language", "rate": 4, "url": "URL", "supported_features": {"custom_language_model": false, "custom_acoustic_model": false, "speaker_labels": false, "low_latency": true}, "description": "Description"}`)
				}))
			})
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			BeforeEach(func() {
				testServer = httptest.NewServer(http.HandlerFunc(func(res http.ResponseWriter, req *http.Request) {
					...
					Expect(req.URL.Query()["model"]).To(Equal([]string{"en-US_BroadbandModel"}))
			...
			It(`Invoke Recognize with error: Operation response processing error`, func() {
				...
				recognizeOptionsModel.Model = core.StringPtr("en-US_BroadbandModel")
				...
				recognizeOptionsModel.WordConfidence = core.BoolPtr(false)
				recognizeOptionsModel.Timestamps = core.BoolPtr(false)
				recognizeOptionsModel.ProfanityFilter = core.BoolPtr(true)
				recognizeOptionsModel.SmartFormatting = core.BoolPtr(false)
				recognizeOptionsModel.SpeakerLabels = core.BoolPtr(false)
				...
				recognizeOptionsModel.Redaction = core.BoolPtr(false)
				recognizeOptionsModel.AudioMetrics = core.BoolPtr(false)
	...
	Describe(`Recognize(recognizeOptions *RecognizeOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke Recognize successfully with retries`, func() {
				speechToTextService, serviceErr := speechtotextv1.NewSpeechToTextV1(&speechtotextv1.SpeechToTextV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
	...
	Describe(`RegisterCallback(registerCallbackOptions *RegisterCallbackOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke RegisterCallback successfully with retries`, func() {
				speechToTextService, serviceErr := speechtotextv1.NewSpeechToTextV1(&speechtotextv1.SpeechToTextV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
	...
	Describe(`CreateJob(createJobOptions *CreateJobOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateJob with error: Operation response processing error`, func() {
				...
				createJobOptionsModel.Model = core.StringPtr("en-US_BroadbandModel")
				...
				createJobOptionsModel.WordConfidence = core.BoolPtr(false)
				createJobOptionsModel.Timestamps = core.BoolPtr(false)
				createJobOptionsModel.ProfanityFilter = core.BoolPtr(true)
				createJobOptionsModel.SmartFormatting = core.BoolPtr(false)
				createJobOptionsModel.SpeakerLabels = core.BoolPtr(false)
				...
				createJobOptionsModel.Redaction = core.BoolPtr(false)
				createJobOptionsModel.ProcessingMetrics = core.BoolPtr(false)
				createJobOptionsModel.ProcessingMetricsInterval = core.Float32Ptr(float32(36.0))
				createJobOptionsModel.AudioMetrics = core.BoolPtr(false)
	...
	Describe(`CheckJobs(checkJobsOptions *CheckJobsOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke CheckJobs successfully with retries`, func() {
				speechToTextService, serviceErr := speechtotextv1.NewSpeechToTextV1(&speechtotextv1.SpeechToTextV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
	...
	Describe(`CheckJob(checkJobOptions *CheckJobOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke CheckJob successfully with retries`, func() {
				speechToTextService, serviceErr := speechtotextv1.NewSpeechToTextV1(&speechtotextv1.SpeechToTextV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
	...
	Describe(`CreateLanguageModel(createLanguageModelOptions *CreateLanguageModelOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint with invalid JSON response`, func() {
			...
			It(`Invoke CreateLanguageModel with error: Operation response processing error`, func() {
				...
				createLanguageModelOptionsModel.BaseModelName = core.StringPtr("ar-MS_Telephony")
	...
	Describe(`CreateLanguageModel(createLanguageModelOptions *CreateLanguageModelOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke CreateLanguageModel successfully with retries`, func() {
				speechToTextService, serviceErr := speechtotextv1.NewSpeechToTextV1(&speechtotextv1.SpeechToTextV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
	...
	Describe(`ListLanguageModels(listLanguageModelsOptions *ListLanguageModelsOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke ListLanguageModels successfully with retries`, func() {
				speechToTextService, serviceErr := speechtotextv1.NewSpeechToTextV1(&speechtotextv1.SpeechToTextV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
	...
	Describe(`GetLanguageModel(getLanguageModelOptions *GetLanguageModelOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke GetLanguageModel successfully with retries`, func() {
				speechToTextService, serviceErr := speechtotextv1.NewSpeechToTextV1(&speechtotextv1.SpeechToTextV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
	...
	Describe(`TrainLanguageModel(trainLanguageModelOptions *TrainLanguageModelOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke TrainLanguageModel successfully with retries`, func() {
				speechToTextService, serviceErr := speechtotextv1.NewSpeechToTextV1(&speechtotextv1.SpeechToTextV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
	...
	Describe(`ListCorpora(listCorporaOptions *ListCorporaOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke ListCorpora successfully with retries`, func() {
				speechToTextService, serviceErr := speechtotextv1.NewSpeechToTextV1(&speechtotextv1.SpeechToTextV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
	...
	Describe(`AddCorpus(addCorpusOptions *AddCorpusOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke AddCorpus successfully`, func() {
				...
				addCorpusOptionsModel.AllowOverwrite = core.BoolPtr(false)
	...
	Describe(`GetCorpus(getCorpusOptions *GetCorpusOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke GetCorpus successfully with retries`, func() {
				speechToTextService, serviceErr := speechtotextv1.NewSpeechToTextV1(&speechtotextv1.SpeechToTextV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
	...
	Describe(`ListGrammars(listGrammarsOptions *ListGrammarsOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke ListGrammars successfully with retries`, func() {
				speechToTextService, serviceErr := speechtotextv1.NewSpeechToTextV1(&speechtotextv1.SpeechToTextV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
	...
	Describe(`AddGrammar(addGrammarOptions *AddGrammarOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke AddGrammar successfully`, func() {
				...
				addGrammarOptionsModel.AllowOverwrite = core.BoolPtr(false)
	...
	Describe(`GetGrammar(getGrammarOptions *GetGrammarOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke GetGrammar successfully with retries`, func() {
				speechToTextService, serviceErr := speechtotextv1.NewSpeechToTextV1(&speechtotextv1.SpeechToTextV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
	...
	Describe(`CreateAcousticModel(createAcousticModelOptions *CreateAcousticModelOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke CreateAcousticModel successfully with retries`, func() {
				speechToTextService, serviceErr := speechtotextv1.NewSpeechToTextV1(&speechtotextv1.SpeechToTextV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
	...
	Describe(`ListAcousticModels(listAcousticModelsOptions *ListAcousticModelsOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke ListAcousticModels successfully with retries`, func() {
				speechToTextService, serviceErr := speechtotextv1.NewSpeechToTextV1(&speechtotextv1.SpeechToTextV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
	...
	Describe(`GetAcousticModel(getAcousticModelOptions *GetAcousticModelOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke GetAcousticModel successfully with retries`, func() {
				speechToTextService, serviceErr := speechtotextv1.NewSpeechToTextV1(&speechtotextv1.SpeechToTextV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
	...
	Describe(`TrainAcousticModel(trainAcousticModelOptions *TrainAcousticModelOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke TrainAcousticModel successfully with retries`, func() {
				speechToTextService, serviceErr := speechtotextv1.NewSpeechToTextV1(&speechtotextv1.SpeechToTextV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
	...
	Describe(`UpgradeAcousticModel(upgradeAcousticModelOptions *UpgradeAcousticModelOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke UpgradeAcousticModel successfully`, func() {
				...
				upgradeAcousticModelOptionsModel.Force = core.BoolPtr(false)
	...
	Describe(`ListAudio(listAudioOptions *ListAudioOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke ListAudio successfully with retries`, func() {
				speechToTextService, serviceErr := speechtotextv1.NewSpeechToTextV1(&speechtotextv1.SpeechToTextV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
	...
	Describe(`AddAudio(addAudioOptions *AddAudioOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke AddAudio successfully`, func() {
				...
				addAudioOptionsModel.AllowOverwrite = core.BoolPtr(false)
	...
	Describe(`GetAudio(getAudioOptions *GetAudioOptions)`, func() {
		...
		Context(`Using mock server endpoint with timeout`, func() {
			...
			It(`Invoke GetAudio successfully with retries`, func() {
				speechToTextService, serviceErr := speechtotextv1.NewSpeechToTextV1(&speechtotextv1.SpeechToTextV1Options{
					URL:           testServer.URL,
					Authenticator: &core.NoAuthAuthenticator{},
				})
	...
	Describe(`Model constructor tests`, func() {
		Context(`Using a service client instance`, func() {
			...
			It(`Invoke NewAddAudioOptions successfully`, func() {
				...
				addAudioOptionsModel.SetAllowOverwrite(false)
				...
				Expect(addAudioOptionsModel.AllowOverwrite).To(Equal(core.BoolPtr(false)))
			...
			It(`Invoke NewAddCorpusOptions successfully`, func() {
				...
				addCorpusOptionsModel.SetAllowOverwrite(false)
				...
				Expect(addCorpusOptionsModel.AllowOverwrite).To(Equal(core.BoolPtr(false)))
			...
			It(`Invoke NewAddGrammarOptions successfully`, func() {
				...
				addGrammarOptionsModel.SetAllowOverwrite(false)
				...
				Expect(addGrammarOptionsModel.AllowOverwrite).To(Equal(core.BoolPtr(false)))
			...
			It(`Invoke NewCreateJobOptions successfully`, func() {
				...
				createJobOptionsModel.SetModel("en-US_BroadbandModel")
				...
				createJobOptionsModel.SetWordConfidence(false)
				createJobOptionsModel.SetTimestamps(false)
				createJobOptionsModel.SetProfanityFilter(true)
				createJobOptionsModel.SetSmartFormatting(false)
				createJobOptionsModel.SetSpeakerLabels(false)
				createJobOptionsModel.SetCustomizationID("testString")
				createJobOptionsModel.SetGrammarName("testString")
				createJobOptionsModel.SetRedaction(false)
				createJobOptionsModel.SetProcessingMetrics(false)
				createJobOptionsModel.SetProcessingMetricsInterval(float32(36.0))
				createJobOptionsModel.SetAudioMetrics(false)
				...
				Expect(createJobOptionsModel.Model).To(Equal(core.StringPtr("en-US_BroadbandModel")))
				...
				Expect(createJobOptionsModel.WordConfidence).To(Equal(core.BoolPtr(false)))
				Expect(createJobOptionsModel.Timestamps).To(Equal(core.BoolPtr(false)))
				Expect(createJobOptionsModel.ProfanityFilter).To(Equal(core.BoolPtr(true)))
				Expect(createJobOptionsModel.SmartFormatting).To(Equal(core.BoolPtr(false)))
				Expect(createJobOptionsModel.SpeakerLabels).To(Equal(core.BoolPtr(false)))
				...
				Expect(createJobOptionsModel.Redaction).To(Equal(core.BoolPtr(false)))
				Expect(createJobOptionsModel.ProcessingMetrics).To(Equal(core.BoolPtr(false)))
				Expect(createJobOptionsModel.ProcessingMetricsInterval).To(Equal(core.Float32Ptr(float32(36.0))))
				Expect(createJobOptionsModel.AudioMetrics).To(Equal(core.BoolPtr(false)))
			...
			It(`Invoke NewCreateLanguageModelOptions successfully`, func() {
				...
				createLanguageModelOptionsBaseModelName := "ar-MS_Telephony"
				...
				createLanguageModelOptionsModel.SetBaseModelName("ar-MS_Telephony")
				...
				Expect(createLanguageModelOptionsModel.BaseModelName).To(Equal(core.StringPtr("ar-MS_Telephony")))
			...
			It(`Invoke NewRecognizeOptions successfully`, func() {
				...
				recognizeOptionsModel.SetModel("en-US_BroadbandModel")
				...
				recognizeOptionsModel.SetWordConfidence(false)
				recognizeOptionsModel.SetTimestamps(false)
				recognizeOptionsModel.SetProfanityFilter(true)
				recognizeOptionsModel.SetSmartFormatting(false)
				recognizeOptionsModel.SetSpeakerLabels(false)
				recognizeOptionsModel.SetCustomizationID("testString")
				recognizeOptionsModel.SetGrammarName("testString")
				recognizeOptionsModel.SetRedaction(false)
				recognizeOptionsModel.SetAudioMetrics(false)
				...
				Expect(recognizeOptionsModel.Model).To(Equal(core.StringPtr("en-US_BroadbandModel")))
				...
				Expect(recognizeOptionsModel.WordConfidence).To(Equal(core.BoolPtr(false)))
				Expect(recognizeOptionsModel.Timestamps).To(Equal(core.BoolPtr(false)))
				Expect(recognizeOptionsModel.ProfanityFilter).To(Equal(core.BoolPtr(true)))
				Expect(recognizeOptionsModel.SmartFormatting).To(Equal(core.BoolPtr(false)))
				Expect(recognizeOptionsModel.SpeakerLabels).To(Equal(core.BoolPtr(false)))
				...
				Expect(recognizeOptionsModel.Redaction).To(Equal(core.BoolPtr(false)))
				Expect(recognizeOptionsModel.AudioMetrics).To(Equal(core.BoolPtr(false)))
			...
			It(`Invoke NewUpgradeAcousticModelOptions successfully`, func() {
				...
				upgradeAcousticModelOptionsModel.SetForce(false)
				...
				Expect(upgradeAcousticModelOptionsModel.Force).To(Equal(core.BoolPtr(false)))
