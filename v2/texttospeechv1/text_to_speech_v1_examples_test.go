...
var _ = Describe(`TextToSpeechV1 Examples Tests`, func() {
	...
	Describe(`TextToSpeechV1 request examples`, func() {
		...
		It(`UpdateCustomModel request example`, func() {
			...
			fmt.Printf("\nUpdateCustomModel() response status code: %d\n", response.StatusCode)
		...
		It(`DeleteSpeakerModel request example`, func() {
			...
			fmt.Printf("\nDeleteSpeakerModel() response status code: %d\n", response.StatusCode)
		...
		It(`DeleteCustomPrompt request example`, func() {
			...
			fmt.Printf("\nDeleteCustomPrompt() response status code: %d\n", response.StatusCode)
		...
		It(`DeleteCustomModel request example`, func() {
			...
			fmt.Printf("\nDeleteCustomModel() response status code: %d\n", response.StatusCode)
