...
var _ = Describe(`DiscoveryV1 Examples Tests`, func() {
	...
	Describe(`DiscoveryV1 request examples`, func() {
		...
		It(`DeleteTrainingExample request example`, func() {
			...
			fmt.Printf("\nDeleteTrainingExample() response status code: %d\n", response.StatusCode)
		...
		It(`DeleteTrainingData request example`, func() {
			...
			fmt.Printf("\nDeleteTrainingData() response status code: %d\n", response.StatusCode)
		...
		It(`DeleteTokenizationDictionary request example`, func() {
			...
			fmt.Printf("\nDeleteTokenizationDictionary() response status code: %d\n", response.StatusCode)
		...
		It(`DeleteStopwordList request example`, func() {
			...
			fmt.Printf("\nDeleteStopwordList() response status code: %d\n", response.StatusCode)
		...
		It(`DeleteExpansions request example`, func() {
			...
			fmt.Printf("\nDeleteExpansions() response status code: %d\n", response.StatusCode)
		...
		It(`DeleteAllTrainingData request example`, func() {
			...
			fmt.Printf("\nDeleteAllTrainingData() response status code: %d\n", response.StatusCode)
