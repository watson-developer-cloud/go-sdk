...
// The type of modification of the feedback entry in the updated labels response.
const (
	Category_Modification_Added = "added"
	Category_Modification_Removed = "removed"
	Category_Modification_Unchanged = "unchanged"
)
...
// The type of modification of the feedback entry in the updated labels response.
const (
	TypeLabel_Modification_Added = "added"
	TypeLabel_Modification_Removed = "removed"
	TypeLabel_Modification_Unchanged = "unchanged"
)
